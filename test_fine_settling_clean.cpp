...
void Report(LBM::Domain &dom, void *UD)
{
    ...
    {
        String fs;
        fs.Printf("%s.out","settling_hex_10.0_20.0_clean");
...
//    }
   ...
   // }else{
    ...
    dom.modexy = 0;
    //solving
    dom.Solve( Tf, dtout, "/home/Staff/uqyche38/macondo/settling_hex_10.0_20.0_clean/test_fine_settling", NULL, Report);
